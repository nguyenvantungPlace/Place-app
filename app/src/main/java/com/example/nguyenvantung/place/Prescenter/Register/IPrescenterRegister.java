...
public interface IPrescenterRegister {
    ...
    void checkFormRegister(String name, String password, String re_password, String uri_image); //hàm kiểm tra form đăng nhập đã thỏa mãn chưa
    void registerUser(String name, String user_name, String password, String image_base64); //hàm đăng ký lên database
